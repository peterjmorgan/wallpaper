...
A cross-platform (Linux, Windows, and macOS) Golang library for getting and setting the desktop background. Forked from github.com/reujab/wallpaper

## Installation

```sh
go get github.com/peterjmorgan/wallpaper
```
